            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="group cursor-pointer">
                    <div className="overflow-hidden rounded-[32px] bg-white p-2 shadow-sm transition-all group-hover:shadow-xl">
                        <img src="/produtos/piramide.png" className="rounded-[28px] w-full h-80 object-cover" />
                ...
                <div className="group cursor-pointer">
                    <div className="overflow-hidden rounded-[32px] bg-white p-2 shadow-sm transition-all group-hover:shadow-xl">
                        <img src="/produtos/milk2.png" className="rounded-[28px] w-full h-80 object-cover" />
                        <div className="p-4 text-center">
                ...
                <div className="group cursor-pointer">
                    <div className="overflow-hidden rounded-[32px] bg-white p-2 shadow-sm transition-all group-hover:shadow-xl">
                        <img src="/produtos/bala.png" className="rounded-[28px] w-full h-80 object-cover" />
                        <div className="p-4 text-center">
